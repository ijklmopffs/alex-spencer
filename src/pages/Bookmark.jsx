...
import bookmarkHero from "../../assets/images/detail/desktop/image-bookmark-hero.jpg";
import bookmarkHeroTablet from "../../assets/images/detail/tablet/image-bookmark-hero.jpg";
import bookmarkHeroMobile from "../../assets/images/detail/mobile/image-bookmark-hero.jpg";
import staticPreview1 from "../../assets/images/detail/desktop/image-bookmark-preview-1.jpg";
import staticPreviewTablet1 from "../../assets/images/detail/tablet/image-bookmark-preview-1.jpg";
import staticPreviewMobile1 from "../../assets/images/detail/mobile/image-bookmark-preview-1.jpg";
import staticPreview2 from "../../assets/images/detail/desktop/image-bookmark-preview-2.jpg";
import staticPreviewTablet2 from "../../assets/images/detail/tablet/image-bookmark-preview-2.jpg";
import staticPreviewMobile2 from "../../assets/images/detail/mobile/image-bookmark-preview-2.jpg";
    ...
    <main className="bg-veryLightGrey">
      <div className="max-w-[1110px] mx-auto p-4">
        ...
        <section className="my-10">
          <img src={bookmarkHero} alt="" className="hidden lg:block" />
          <img
            src={bookmarkHeroTablet}
            alt=""
            className="hidden md:block lg:hidden mx-auto"
          />
          <img src={bookmarkHeroMobile} alt="" className="md:hidden mx-auto" />
        </section>
          ...
          <div className="text-start">
            ...
            <div className="md:flex justify-between items-center lg:block">
              ...
              <p className="w-96 text-sm md:text-base font-sans my-5 md:my-0 lg:my-10">
                {projects.bookmark.excerpt}
              </p>
            </div>
            <div className="flex items-center gap-1 lg:my-5">
              <p className="text-cyan font-bold font-sans">
                {projects.bookmark.roles.join(" / ")}
              </p>
            </div>
            <div className="flex items-center gap-1 my-5">
              <p className="text-cyan font-bold font-sans">
                {projects.bookmark.languages.join(" / ")}
              </p>
            </div>
            <Link
              to="https://bookmark-your-page-for-devs.netlify.app/"
              target="_blank"
            >
