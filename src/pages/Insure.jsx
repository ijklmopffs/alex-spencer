...
import insureHero from "../../assets/images/detail/desktop/image-insure-hero.jpg";
import insureHeroTablet from "../../assets/images/detail/tablet/image-insure-hero.jpg";
import insureHeroMobile from "../../assets/images/detail/mobile/image-insure-hero.jpg";
import staticPreview1 from "../../assets/images/detail/desktop/image-insure-preview-1.jpg";
import staticPreviewTablet1 from "../../assets/images/detail/tablet/image-insure-preview-1.jpg";
import staticPreviewMobile1 from "../../assets/images/detail/mobile/image-insure-preview-1.jpg";
import staticPreview2 from "../../assets/images/detail/desktop/image-insure-preview-2.jpg";
import staticPreviewTablet2 from "../../assets/images/detail/tablet/image-insure-preview-2.jpg";
import staticPreviewMobile2 from "../../assets/images/detail/mobile/image-insure-preview-2.jpg";
    ...
    <main className="bg-veryLightGrey">
      <div className="max-w-[1110px] mx-auto p-4">
        ...
        <section className="my-10">
          <img src={insureHero} alt="" className="hidden lg:block" />
          <img
            src={insureHeroTablet}
            alt=""
            className="hidden md:block lg:hidden mx-auto"
          />
          <img src={insureHeroMobile} alt="" className="md:hidden mx-auto" />
        </section>
          ...
          <div className="text-start">
            ...
            <div className="md:flex justify-between items-center lg:block">
              ...
              <p className="w-96 text-sm md:text-base font-sans my-5 md:my-0 lg:my-10">
                {projects.insure.excerpt}
              </p>
            </div>
            <div className="flex items-center gap-1 lg:my-5">
              <p className="text-cyan font-bold font-sans">
                {projects.insure.roles.join(" / ")}
              </p>
            </div>
            <div className="flex items-center gap-1 my-5">
              <p className="text-cyan font-bold font-sans">
                {projects.insure.languages.join(" / ")}
              </p>
            </div>
            <Link to="https://ijklmopffs.github.io/Insure/" target="_blank">
          ...
          <div className="flex justify-between cursor-pointer">
            <Link to="/portfolio/bookmark">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-grayishDarkBlue text-3xl">Bookmark</h3>
            ...
            <Link to="/portfolio/fylo">
              <div className="flex items-center gap-4">
                <div className="text-end">
                  <h3 className="text-grayishDarkBlue text-3xl">Fylo</h3>
