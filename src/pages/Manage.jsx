...
import manageHero from "../../assets/images/detail/desktop/image-manage-hero.jpg";
import manageHeroTablet from "../../assets/images/detail/tablet/image-manage-hero.jpg";
import manageHeroMobile from "../../assets/images/detail/mobile/image-manage-hero.jpg";
import staticPreview1 from "../../assets/images/detail/desktop/image-manage-preview-1.jpg";
import staticPreviewTablet1 from "../../assets/images/detail/tablet/image-manage-preview-1.jpg";
import staticPreviewMobile1 from "../../assets/images/detail/mobile/image-manage-preview-1.jpg";
import staticPreview2 from "../../assets/images/detail/desktop/image-manage-preview-2.jpg";
import staticPreviewTablet2 from "../../assets/images/detail/tablet/image-manage-preview-2.jpg";
import staticPreviewMobile2 from "../../assets/images/detail/mobile/image-manage-preview-2.jpg";
    ...
    <main className="bg-veryLightGrey">
      <div className="max-w-[1110px] mx-auto p-4">
        ...
        <section className="my-10">
          <img src={manageHero} alt="" className="hidden lg:block" />
          <img
            src={manageHeroTablet}
            alt=""
            className="hidden md:block lg:hidden mx-auto"
          />
          <img src={manageHeroMobile} alt="" className="md:hidden mx-auto" />
        </section>
          ...
          <div className="text-start">
            ...
            <div className="md:flex justify-between items-center lg:block">
              ...
              <p className="w-96 text-sm md:text-base font-sans my-5 md:my-0 lg:my-10">
                {projects.manage.excerpt}
              </p>
            </div>
            <div className="flex items-center gap-1 lg:my-5">
              <p className="text-cyan font-bold font-sans">
                {projects.manage.roles.join(" / ")}
              </p>
            </div>
            <div className="flex items-center gap-1 my-5">
              <p className="text-cyan font-bold font-sans">
                {projects.manage.languages.join(" / ")}
              </p>
            </div>
            <Link
              to="https://ijklmopffs.github.io/Manage-Landing-Page/"
              target="_blank"
            >
